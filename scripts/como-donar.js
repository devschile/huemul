...
module.exports = robot => {
 ...
 · *Débito, Crédito*: Tenemos una alianza con _QVO_ para realizar pagos a la comunidad (donaciones, productos, etc.) a través de este medio. DM con @jorgeepunan para solicitar este medio de pago.\n \
 . *Cryptos*: recibimos lo equivalente a US$10 en algunos wallets:\n \
   - BTC: ${WALLET_BTC}\n \
   - ETH: ${WALLET_ETH}\n \
Gracias :pray: por el interés y por las ganas de aportar a que siga creciendo la comunidad devsChile. :heartbeat:`
    )
  })
}
