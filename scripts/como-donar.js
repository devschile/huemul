...
module.exports = robot => {
 ...
 . *Cryptos*: recibimos lo equivalente a US$10 en algunos wallets:\n \
   - BTC: ${WALLET_BTC}\n \
   - ETH: ${WALLET_ETH}\n \
Gracias :pray: por el interés y por las ganas de aportar a que siga creciendo la comunidad devsChile. Hacemos buen uso de las donaciones, desde el pago de los _servers_ hasta concursos y sorteos de cursos Udemy entre otros. :heartbeat:`
    )
  })
}
